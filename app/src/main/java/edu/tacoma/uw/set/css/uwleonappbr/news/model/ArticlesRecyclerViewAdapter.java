...
import edu.tacoma.uw.set.css.uwleonappbr.databinding.FragmentArticlesDetailBinding;
...
public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        .inflate(R.layout.fragment_articles_detail, parent, false));
        }
...
public static class ViewHolder extends RecyclerView.ViewHolder {
    ...
    public @NonNull FragmentArticlesDetailBinding binding;
    public Article mItem;
    public ViewHolder(View view) {
        super(view);
        mView = view;
        binding = FragmentArticlesDetailBinding.bind(view);
    }
